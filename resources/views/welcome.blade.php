...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="text-center">
        ...
        <p class="mt-4 text-gray-700">Thisdscss is a saxsacimple wsscelcome page xddcscascvreatxaxasczded indv asdcwsDCLaravel.cfvddvfdvdfv for v dcdb testing test findcdddda1 final </p>
